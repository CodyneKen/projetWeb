...
$requete = 'SELECT nomArticle, descriptif, prix, img, stock FROM Articles WHERE categorie = "informatique"';
...
<body>
    ...
    while ($ligne = $resultat->fetch()) {
        ...
        echo "<br>";
        echo "<br>";
        echo "<button id='$idArticle' onclick='ajouterPanier($idArticle)' >Ajouter au panier</button>";
        echo "</div>";
        echo "<div class = 'box2'>";
